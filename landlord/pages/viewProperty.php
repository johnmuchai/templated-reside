...
if (isset($_POST['submit']) && $_POST['submit'] == 'recordPay') {
	...
	if($_POST['paymentDate'] == '') {
		...
		payments(
			...
			$msgBox = alertBox($savePayMsg." \"".$propertyName."\" ".$newDiscCmtMsg2."-".$err.":".$inserted, "<i class='fa fa-check-square'></i>", "success");
									...
									<ul class="list-group mb-10">
										...
										if ($set['enablePayments'] == '1') {
											if ($tenantIsLate == 'true') {
												...
												<strong>Current Amount Past-Due:</strong> '.formatCurrency($rentAmount,$currCode).'
												</span>
												</li>
												';
												...
												<strong>Current Amount Due:</strong> '.formatCurrency($rentAmount,$currCode).'
												</span>
												</li>
												';
											}
